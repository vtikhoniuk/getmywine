...
- [ ] AC 3: Бот отвечает на команду /start приветственным сообщением 
- [ ] AC 4: Приветственное сообщение содержит краткое описание возможностей бота и 3 рекомендации на основе контекста пользователя как и в веб-версии
- [ ] AC 5: Бот работает с тем же профилем пользователя, что и веб-версия
- Notes: Единая точка входа для пользователей мессенджеров

---

**[US-021][Пользователь] Как пользователь, я хочу получать рекомендации вин через Telegram так же, как в веб-версии.**
- [ ] AC 1: Бот принимает свободные текстовые запросы о вине
- [ ] AC 2: Бот рекомендует вина из каталога с обоснованием
- [ ] AC 3: Бот учитывает профиль пользователя при рекомендациях
- [ ] AC 4: Бот может рекомендовать вина под блюдо или событие
- [ ] AC 5: Бот отображает персонализированные подсказки для запросов
- Notes: Функциональность идентична веб-версии

---

**[US-022][Пользователь] Как пользователь, я хочу видеть информацию о вине в удобном формате в Telegram.**
- [ ] AC 1: Информация о вине отображается структурированно (название, регион, сорт, год)
- [ ] AC 2: Вкусовые характеристики и описание читаемы в мобильном формате
- [ ] AC 3: Цена показана в понятном виде
- [ ] AC 4: Обоснование рекомендации выделено отдельно
- Notes: Адаптация контента под формат мессенджера
