...
Реализация истории сессий для AI-Sommelier: поддержка множественных диалогов на пользователя, автоматическое именование сессий по теме, сайдбар с историей, персонализированные welcome-сообщения на основе прошлых сессий, и управление жизненным циклом сессий (30 мин inactivity, 90 дней хранения).
