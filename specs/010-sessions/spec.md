...
Реализация системы сессий для AI-Sommelier, позволяющей пользователям иметь несколько диалогов с сомелье, просматривать историю прошлых разговоров и получать персонализированные рекомендации на основе накопленного опыта.
