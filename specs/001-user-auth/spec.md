...
**Создана**: 2026-02-02
**Статус**: Черновик
**Вход**: Регистрация и авторизация пользователей для GetMyWine. Email + пароль, сессии 7 дней, проверка возраста 18+, rate limiting 5 попыток / 15 мин. Соответствие 152-ФЗ.
...
**Независимый тест**: Можно полностью протестировать, создав аккаунт и войдя в систему. Пользователь получает доступ к чату с GetMyWine.
