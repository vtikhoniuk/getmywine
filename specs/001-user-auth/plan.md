...
Реализация системы регистрации и авторизации для AI-Sommelier: email + пароль, проверка возраста 18+, сессии 7 дней, rate limiting, восстановление пароля. Соответствие 152-ФЗ (данные в РФ).
