...
Диалог пользователя с GetMyWine. Один пользователь имеет один диалог (для MVP).
...
```
Привет! Я GetMyWine, и я помогу вам разобраться в мире вина. 🍷
