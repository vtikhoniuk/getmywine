...
Реализация каталога вин для GetMyWine: модель данных Wine с полным набором характеристик, API для CRUD и поиска (включая семантический через pgvector), и seed data из 50 реальных вин с изображениями.
