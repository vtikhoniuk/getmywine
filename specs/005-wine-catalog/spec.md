...
Система должна хранить структурированный каталог вин с полными характеристиками, чтобы GetMyWine мог давать точные рекомендации на основе реальных данных.
...
2. **Given** каталог содержит вина разных цен, **When** ищу в диапазоне 4000₽-8000₽, **Then** получаю только вина в этом ценовом диапазоне
...
3. **Given** seed применён, **When** проверяю цены, **Then** 90% вин в диапазоне 4000₽-8000₽, 10% премиум (8000₽+)
...
- **FR-004**: Система MUST хранить ценовой диапазон (min/max или среднюю цену в RUB)
...
- **Wine**: Основная сущность — вино с полным набором характеристик
  ...
  - Цена: price_rub, price_range (enum: budget/mid/premium)
  - Медиа: image_url
